...
FIELD_MAPPINGS.update({
    ...
    'DateField': {'class': 'django.forms.DateField', 'widget': 'django.forms.DateTimeInput',
                  'widget_attrs': {'class': 'datepicker'}},
    'CheckboxInput': {'class': 'django.forms.BooleanField', 'widget': 'django.forms.CheckboxInput'},
    'CheckboxSelectMultiple': {'class': 'django.forms.MultipleChoiceField',
...
MULTI_CHOICE_FIELDS = getattr(settings, "DATAFORMS_MULTI_CHOICE_FIELDS", ()) + \
...
ADMIN_JS = REMOTE_JQUERY_JS + ('%sdataforms/js/admin.js' % settings.STATIC_URL,)
